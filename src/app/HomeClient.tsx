        ...
        >
          ...
          <div className="hero-title-container absolute inset-0 flex items-start justify-center pointer-events-none z-50 pt-[clamp(0.75rem,4.5vh,3.5rem)]">
            <div className="text-center px-2 sm:px-6 max-w-3xl lg:max-w-none">
              <p className={`uppercase tracking-[0.18em] text-[0.68rem] sm:text-[0.72rem] text-[#3f311d] dark:text-[#d8c7ab] mb-2 sm:mb-3 transition-all duration-700 ${showWelcome ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3"}`}>
                Anjie Zhou
              </p>
              ...
              <p className={`mt-2 sm:mt-3 text-[0.86rem] sm:text-sm text-[#352919] dark:text-[#d9c8ad] transition-all duration-700 ${showToMyWorld ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}>
